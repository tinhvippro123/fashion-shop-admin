...
export default function EditBlogPage() {
  const [content, setContent] = useState("<p>Đây là nội dung bài viết mẫu đã có sẵn...</p>");
    ...
    <div className="flex flex-col gap-6 w-full pb-10">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <BackButton />
          <div>
            <h2 className="text-2xl font-bold tracking-tight">Chỉnh sửa bài viết</h2>
            <p className="text-zinc-500">Cập nhật nội dung và xuất bản lại bài viết.</p>
          </div>
        </div>
          ...
          <Card>
            ...
            <CardContent className="flex flex-col gap-6">
              <div className="grid gap-2">
                ...
                <Input id="title" defaultValue="10 Cách Phối Đồ Đi Đà Lạt Mùa Lạnh Cực Xinh Cho Nữ" className="text-lg" />
              </div>
              
              <div className="grid gap-2">
                <Label htmlFor="slug" className="font-semibold">Đường dẫn tĩnh (Slug)</Label>
                <Input id="slug" defaultValue="10-cach-phoi-do-di-da-lat" className="bg-zinc-50 text-zinc-500" />
          ...
          <Card>
            ...
            <CardContent className="flex flex-col gap-4">
              <div className="grid gap-2">
                ...
                <Input id="seoTitle" defaultValue="10 Cách Phối Đồ Đi Đà Lạt Mùa Lạnh Cực Xinh Cho Nữ - LUXE Blog" />
              </div>
              <div className="grid gap-2">
                <Label htmlFor="seoDesc">Thẻ Mô tả (Meta Description)</Label>
                <Textarea id="seoDesc" defaultValue="Bí kíp phối đồ đi Đà Lạt siêu ấm áp mà vẫn cực kỳ thời trang dành cho các nàng yêu cái đẹp..." rows={3} />
              </div>
            </CardContent>
          </Card>
        </div>
          ...
          <Card>
            ...
            <CardContent className="grid gap-4">
              ...
              <div className="grid gap-2">
                ...
                <Input id="tags" defaultValue="đà lạt, mùa đông, phối đồ" />
          ...
          <Card>
            ...
            <CardContent>
              <div className="border-2 border-dashed border-zinc-200 rounded-lg p-6 flex flex-col items-center justify-center text-center cursor-pointer hover:bg-zinc-50 transition-colors">
                ...
                <p className="text-sm font-medium text-zinc-700">Đã chọn 1 ảnh</p>
                <p className="text-xs text-zinc-500 mt-1">cover_dalat.jpg</p>
              </div>
            </CardContent>
          </Card>
