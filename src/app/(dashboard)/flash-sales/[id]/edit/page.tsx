...
import { Zap, Clock, Plus, Trash2 } from "lucide-react";
import {
  Table,
  TableBody,
  TableCell,
    ...
    <div className="flex flex-col gap-6 w-full pb-10">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <BackButton />
          <div>
            <h2 className="text-2xl font-bold tracking-tight">Chỉnh sửa Flash Sale</h2>
            <p className="text-zinc-500">Cập nhật thông tin khung giờ hoặc sản phẩm chạy giá sốc.</p>
          </div>
        </div>
        <div className="flex items-center gap-3">
          <Button variant="outline">Hủy</Button>
          <Button className="gap-2 bg-zinc-900 hover:bg-zinc-800">
            <Zap className="h-4 w-4" /> Cập nhật chiến dịch
          </Button>
        </div>
      </div>
          ...
          <Card>
            ...
            <CardContent className="flex flex-col gap-4">
              <div className="grid gap-2">
                ...
                <Input id="name" defaultValue="Siêu Sale Mùa Hè - Đồng Giá 99k" />
              </div>
              ...
              <div className="grid gap-2 mt-4">
                ...
                <Input type="datetime-local" defaultValue="2024-06-15T12:00" />
              </div>

              <div className="grid gap-2">
                <Label className="font-semibold text-zinc-600">Kết thúc lúc</Label>
                <Input type="datetime-local" defaultValue="2024-06-15T14:00" />
